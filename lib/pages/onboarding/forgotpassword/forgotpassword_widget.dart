    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('FORGOTPASSWORD_arrow_back_rounded_ICN_ON');
        ...
        children: [
          ...
          Padding(
            ...
            child: FFButtonWidget(
              onPressed: () async {
                logFirebaseEvent('FORGOTPASSWORD_PAGE_CONTINUE_BTN_ON_TAP');
          ...
          Padding(
            padding: EdgeInsetsDirectional.fromSTEB(16.0, 10.0, 16.0, 44.0),
            child: FFButtonWidget(
              onPressed: () async {
                logFirebaseEvent('FORGOTPASSWORD_PAGE_CANCEL_BTN_ON_TAP');
                logFirebaseEvent('Button_navigate_to');
