...
import 'splash_screen4_model.dart';
export 'splash_screen4_model.dart';

class SplashScreen4Widget extends StatefulWidget {
  const SplashScreen4Widget({super.key});

  static String routeName = 'SplashScreen4';
  static String routePath = 'splashScreen4';
...
class _SplashScreen4WidgetState extends State<SplashScreen4Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SplashScreen4'});
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/Seated_Forward_Bend_Yoga_Pose.png',
                              width: 300.0,
                              height: 212.4,
                              fit: BoxFit.scaleDown,
                            ),
                    ...
                    children: [
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 16.0, 0.0, 0.0),
                                            child: Text(
                                              'Log your symptoms and receive AI-driven recommendations tailored to your condition. Get actionable advice on nutrition, exercise, and wellness to stay on top of your health.',
                                              textAlign: TextAlign.center,
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'SPLASH_SCREEN4_PAGE_LOGIN_BTN_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'SPLASH_SCREEN4_PAGE_SIGN_UP_BTN_ON_TAP');
                            logFirebaseEvent('Button_navigate_to');
