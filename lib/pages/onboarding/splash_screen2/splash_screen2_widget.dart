...
class _SplashScreen2WidgetState extends State<SplashScreen2Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SplashScreen2'});
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/Lotus_Yoga_Pose.png',
                              width: 300.0,
                              height: 212.38,
                              fit: BoxFit.scaleDown,
                            ),
                      ...
                      children: [
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  22.0, 16.0, 22.0, 0.0),
                                          child: Text(
                                            'NutriFit uses advanced AI to provide customized meal plans and workout routines that adapt to your fitness goals, dietary needs, and personal preferences. Get expert-backed guidance at your fingertips.',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'SPLASH_SCREEN2_PAGE_NEXT_BTN_ON_TAP');
                              logFirebaseEvent('Button_navigate_to');

                              context.pushNamed(
                                SplashScreen3Widget.routeName,
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'SPLASH_SCREEN2_PAGE_SKIP_BTN_ON_TAP');
                              logFirebaseEvent('Button_navigate_to');
