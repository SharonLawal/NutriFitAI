...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : SplashScreen1Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: EatingPreferencesWidget.routeName,
              path: EatingPreferencesWidget.routePath,
              requireAuth: true,
            ...
            FFRoute(
              name: SplashScreen3Widget.routeName,
              path: SplashScreen3Widget.routePath,
              builder: (context, params) => SplashScreen3Widget(),
            ),
            FFRoute(
              name: SplashScreen4Widget.routeName,
              path: SplashScreen4Widget.routePath,
              builder: (context, params) => SplashScreen4Widget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: MealPlanningWidget.routeName,
              path: MealPlanningWidget.routePath,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'MealPlanning')
                  : MealPlanningWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: ExercisePlanningWidget.routeName,
              path: ExercisePlanningWidget.routePath,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'ExercisePlanning')
                  : ExercisePlanningWidget(),
            ),
            FFRoute(
              name: WeightTrackerWidget.routeName,
              path: WeightTrackerWidget.routePath,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'WeightTracker')
                  : WeightTrackerWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: SignUp1CopyWidget.routeName,
              path: SignUp1CopyWidget.routePath,
              builder: (context, params) => SignUp1CopyWidget(),
            )
